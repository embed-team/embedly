      ...
      <div className="flex flex-col flex-1 gap-8 container mx-auto px-6 py-8">
        ...
        <div className="flex flex-col gap-6 text-fd-accent-foreground/75">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex flex-col gap-3 bg-fd-accent/50 border border-fd-muted p-4 rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
              <p className="text-sm leading-none font-medium italic">Create embeds with /embed</p>
              <div className="rounded-t-lg rounded-b-xl overflow-clip">
                <video
                  muted
        ...
        <footer className="flex flex-col sm:flex-row items-center justify-between gap-4 py-6 text-xs text-fd-muted-foreground">
          <div className="flex items-center gap-3">
            <span className="border rounded-full px-2.5 py-1 font-mono">v{BOT_VERSION}</span>
            <span className="text-fd-muted-foreground/40">·</span>
            <a href="/privacy" className="hover:text-fd-foreground transition-colors">
              Privacy Policy
            </a>
            <span className="text-fd-muted-foreground/40">·</span>
            <a href="/terms" className="hover:text-fd-foreground transition-colors">
              Terms of Service
            </a>
          </div>
