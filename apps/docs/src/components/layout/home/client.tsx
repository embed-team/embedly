/** biome-ignore-all lint/suspicious/noArrayIndexKey: this is a fumadocs generated component */
"use client";
      ...
      <div className="flex flex-row items-center justify-end gap-1.5 flex-1 max-lg:hidden">
        {searchToggle.enabled !== false &&
          (searchToggle.components?.lg ?? (
            <LargeSearchToggle className="w-full rounded-full ps-2.5 max-w-60" hideIfDisabled />
          ))}
